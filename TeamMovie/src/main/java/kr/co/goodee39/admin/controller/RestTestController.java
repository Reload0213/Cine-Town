...
import kr.co.goodee39.admin.service.AdminService;import kr.co.goodee39.admin.service.noticeService;
...
//	public ResponseEntity<List<NoticeVO>> boardLoad(NoticeVO noticeVo) {
//       
//		service.selectNoticeList(noticeVo);
//		
//	ResponseEntity<List<NoticeVO>> entity = new ResponseEntity<List<NoticeVO>>(service.selectNoticeList(noticeVo),HttpStatus.OK);
//		
//	
//	return entity;
//		
