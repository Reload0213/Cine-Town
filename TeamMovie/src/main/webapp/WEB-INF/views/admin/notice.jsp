		...
		<div class="quickViewCon">
			<div class="quickView">
				...
				<c:choose>
					...
					<c:otherwise>
						<a
							href="${pageContext.request.contextPath}/admin/board/notice?num=${minBlock-1}">◀◀</a>
					</c:otherwise>
				...
				<c:choose>
					...
					<c:otherwise>
						<a
							href="${pageContext.request.contextPath}/admin/board/notice?num=${num-1}">◀</a>
					</c:otherwise>
				...
				<c:forEach begin="${minBlock}"
					...
					<c:choose>
						...
						<c:otherwise>
							<a href="${pageContext.request.contextPath}/admin/board/notice?num=${i}">${i}</a>
						</c:otherwise>
					</c:choose>
				</c:forEach>
				...
				<c:choose>
					...
					<c:otherwise>
						<a
							href="${pageContext.request.contextPath}/admin/board/notice?num=${maxBlock+1}">▶▶</a>
					</c:otherwise>
