...
<body>
	...
	<%@ include file="../include/header.jsp"%>
		...
		<div class="container">
			...
			<p>${sessionScope.account.userName}님의 장바구니는 비어있습니다.</p>
						...
						<div class="subdiv">
							<div class="basketprice">
								<input type="hidden" name="p_price" id="p_price1"
									class="p_price" value="20000">비어있음
							</div>
							<div class="num">
								<div class="updown">
				...
				<div class="row justify-content-end">
					...
					<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
						<div class="cart-total mb-3">
							<h3>Cart Totals</h3>
							<p class="d-flex">
								<span>합계금액</span> <span id="sum_p_price">0원</span>
							</p>
							<p class="d-flex">
								<span>상품갯수</span> <span id="sum_p_num">0개</span>
							</p>
							<p class="d-flex">
		...
		<div class="container">
			...
			<p>영화가 마음에 드셨나요? 저희 CGV에서 관련 굿즈를 구매해 보세요 </p>
			 <form name="orderform" id="orderform" method="post" class="orderform"> 
		<%-- 	<form:form modelAttribute="cartVO" name="orderform" id="orderform"  class="orderform"> --%>
				...
				<div class="basketdiv " id="basket">
					...
					<div class="row head ">
						<div class="subdiv">
							...
							<!-- <div class="img"><img src="assets/images/cart/about.jpg" width="60"></div> -->
							<div class="pname">
								<a href="goods/GoodsMain"><span>${row.gdsName}</span></a>
							</div>
						</div>
						<div class="subdiv">
							<div class="basketprice">
						 ...
						 <div class="subdiv"> 
							...
							<form:form modelAttribute="cartVO" action="${pageContext.request.contextPath }/cart/deleteCartItem" class="basketcmd">
							<form:hidden path="cartNum" value="${row.cartNum }"/>
									<form:button type="submit" class="abutton">삭제</form:button>
									</form:form>
						 </div> 
					</div>
