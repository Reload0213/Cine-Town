...
<main>
	...
	<body class="single-blog-post">
		<div class="page-header">
			...
			<div class="page-header-overlay" style="height: 1000px">
				<div class="container">
					<div class="row">
						<div class="col-12">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-8">
					<div class="single-post-wrap">
						<p>This is what we do: My husband monitors travel sites and
							email subscription services for super-cheap flights or error
							fares. Sometimes one of us travels for work and the other tags
							along. When we find a good deal, we make a split-second
							decision—because great airfares don’t last long—and then start
							planning. We’re both freelance writers, so we have some
							flexibility in terms of scheduling. We watch hotel prices, and
							often book rooms using points, free nights and other discounts.
							We plan carefully, and if we decide that a trip might involve
							stops in multiple cities, we price our transportation options. We
							check exchange rates on currency. We read up on attractions, look
							for deals, and seek out free walking tours.</p>

						<blockquote>
							Some people dream of success, while other people get up every
							morning and make it happen.” <span>Wayne Huizenga</span>
						</blockquote>

						<p>In the past few years, we’ve been to mountains, beaches,
							massive cities and isolated towns you could speed through in a
							blink. We’ve been all over the U.S. and to a dozen or so
							countries. That means long flights, wandering dazedly through
							strange places, sometimes not knowing what or where we’ll be
							eating next or exactly when we’ll make it to our next
							destination. But it also means volcanoes, glaciers, geysers and
							warm friendly strangers from all over the world.</p>

						<p>And it means memories we’ll treasure forever. Our friends
							think it’s kind of kitschy, but my husband, Mike, and I collect
							magnets from the places we go. We arrange them on the side of the
							fridge that faces our table in the kitchen, so that when we’re
							sitting together we can see the collection, which reminds us of
							some of our happiest times.</p>

						<figure class="my-4">
							<img src="${pageContext.request.contextPath}/assets/images/movieDetail/blog-post-img.png" alt="">
						</figure>
						...
						<p>In some countries, you need only to scan a busy street to
							...
							which American exports might be the next big thing somewhere
							else. (In Portugal, we were surprised when a woman in her 20s
							told us how much she loves Guy Fieri.)</p>
					</div>
					<!-- .single-post-wrap -->
					...
					<div class="related-blog-posts">
						...
						<div class="row mx-m-25">
							<div class="col-12 col-lg-6 px-25">
								<div class="blog-post-content">
									<figure class="blog-post-thumbnail position-relative m-0">
										<a href="#"><img src="${pageContext.request.contextPath}/assets/images/movieDetail/b-5.jpg"
											alt=""></a>
							...
							<div class="col-12 col-lg-6 px-25">
								<div class="blog-post-content">
									<figure class="blog-post-thumbnail position-relative m-0">
										<a href="#"><img src="${pageContext.request.contextPath}/assets/images/movieDetail/b-6.jpg"
											alt=""></a>
						...
						<div class="post-comments">
							...
							<ol class="comment-list">
								<li class="comment">
									<article class="comment-body">
										<figure class="comment-author-avatar">
											<img src="${pageContext.request.contextPath}/assets/images/movieDetail/c-1.png" alt="">
										</figure>
									...
									<ol class="children">
										<li class="comment">
											<article class="comment-body">
												<figure class="comment-author-avatar">
													<img src="${pageContext.request.contextPath}/assets/images/movieDetail/c-2.png" alt="">
												</figure>
												<!-- .comment-author-avatar -->
								...
								<li class="comment">
									<article class="comment-body">
										<figure class="comment-author-avatar">
											<img src="${pageContext.request.contextPath}/assets/images/movieDetail/c-3.png" alt="">
										</figure>
										<!-- .comment-author-avatar -->
			...
			<div class="container">
				<div class="row mx-m-25">
					...
					<div class="col-12 col-md-6 col-lg-4 px-25">
						<div class="course-content">
							<figure class="course-thumbnail">
								<a href="#"><img src="${pageContext.request.contextPath}/assets/images/movieDetail/1.jpg"
									alt=""></a>
							</figure>
							<!-- .course-thumbnail -->
					...
					<div class="col-12 col-md-6 col-lg-4 px-25">
						<div class="course-content">
							<figure class="course-thumbnail">
								<a href="#"><img src="${pageContext.request.contextPath}/assets/images/movieDetail/2.jpg"
									alt=""></a>
							</figure>
							<!-- .course-thumbnail -->
					...
					<div class="col-12 col-md-6 col-lg-4 px-25">
						<div class="course-content">
							<figure class="course-thumbnail">
								<a href="#"><img src="${pageContext.request.contextPath}/assets/images/movieDetail/3.jpg"
									alt=""></a>
							</figure>
							<!-- .course-thumbnail -->
					...
					<div class="col-12 col-md-6 col-lg-4 px-25">
						<div class="course-content">
							<figure class="course-thumbnail">
								<a href="#"><img src="${pageContext.request.contextPath}/assets/images/movieDetail/4.jpg"
									alt=""></a>
							</figure>
							<!-- .course-thumbnail -->
					...
					<div class="col-12 col-md-6 col-lg-4 px-25">
						<div class="course-content">
							<figure class="course-thumbnail">
								<a href="#"><img src="${pageContext.request.contextPath}/assets/images/movieDetail//5.jpg"
									alt=""></a>
							</figure>
							<!-- .course-thumbnail -->
					...
					<div class="col-12 col-md-6 col-lg-4 px-25">
						<div class="course-content">
							<figure class="course-thumbnail">
								<a href="#"><img src="${pageContext.request.contextPath}/assets/images/movieDetail/6.jpg"
									alt=""></a>
							</figure>
							<!-- .course-thumbnail -->
